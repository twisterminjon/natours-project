        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              console.log('secces');
              (0, _alerts.showAlert)('success', 'Loggedd in successfully!');
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHdpc3RlcjE3IiwiYSI6ImNrczh0ajRmazNjMnEycW1zOTM2ZnFsZ2oifQ.jBfEJb4P7I9pxQsMancQ-g';
  ...
  var bounds = new mapboxgl.LngLatBounds(); // const loc = locations[0];
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? 'http://127.0.0.1:4000/api/v1/users/updatePassword' : 'http://127.0.0.1:4000/api/v1/users/updateMe';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var updatePassForm = document.querySelector('.form-user-settings'); //VALUES
//DELEGATION
...
if (updatePassForm) {
  updatePassForm.addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
      var oldPassword, newPassword, newConfPass;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              newConfPass = document.getElementById('password-confirm').value;
              _context.next = 7;
